    ...
    <section className={clsx(styles.root, 'layout-grid-inner')}>
      ...
      <div className={styles.desc}>
        <AppearTitle key="overview-desc">
          <p className="h6">Homies Studio is a technology studio operating across India, founded to bridge the gap between engineering education and real-world technical execution.</p>
          <p className={clsx(styles.paddingTop, 'h6')}>The studio operates two primary service wings and one marketplace:</p>

          <h3 className={clsx(styles.paddingTop, 'h6')} style={{ color: '#c5a359', letterSpacing: '0.04em' }}>
          ...
          <p className="h6">1. Engineering students seeking final year project guidance (pan-India, remote)</p>
          <p className="h6">2. Engineering colleges seeking structured student project support programs</p>
          <p className="h6">3. Startups and EdTech companies seeking AI product development</p>
          <p className="h6">4. Developer-creators looking to monetize their technical projects</p>

          <p className={clsx(styles.paddingTop, 'h6')}>
            Email:{' '}
